...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_preonic_grid(
    ...
    KC_2,    NO_BSLS, NO_QUO2, _______, NO_EURO, _______, _______, NO_QUOT, NO_LBRC, NO_RBRC, KC_KP_ASTERISK, _______,
    _______, KC_2,    _______, _______, _______, _______, _______, _______, NO_LESS, NO_GRTR, NO_CIRC,        _______,
  ...
  [_RAISE] = LAYOUT_preonic_grid(
    ...
    NO_PIPE_ALT, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,      KC_7,        KC_8,    KC_9,    KC_0,    NO_AM,
    _______,     _______, NO_QUOT, _______, _______, UC_MOD,  X(UMLAUT), NO_BSLS_ALT, NO_LCBR, NO_RCBR, NO_OSLH, NO_AE,
